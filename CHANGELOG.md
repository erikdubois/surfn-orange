...
Initial standalone repo. The **Surfn-Orange** theme was carved out of the monolithic
`erikdubois/surfn` repo so it ships as its own package, `surfn-orange-icons-git`, depending on the base
`surfn-icons-git`.

### Technical Details

- `usr/share/icons/Surfn-Orange/` copied verbatim from the monolith; theme dir kept PascalCase
...
- Initial scaffold + usr/share/icons/Surfn-Orange/
